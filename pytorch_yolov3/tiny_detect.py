...
if __name__ == "__main__":
    ...
    '''
        在config/yolov3.cfg的文件里面，包含了yolov3的DarkNet版本的定义
        将该定义读取之后，创建对应的模型
    '''
    # Set up model
    ...
    #     print(name,layer.shape,layer.requires_grad)
    #
    # print('=========')
    ...
    dataloader = DataLoader(
        # 这个是一个自定义的dataset，里面也是ToTensor->padtosquear->resize的路子
    ...
    for batch_i, (img_paths, input_imgs) in enumerate(dataloader):
        ...
        # Get detections
        with torch.no_grad():
            print('input images shape',input_imgs.shape)
